...
$('.cup50222').click(function() {
  earnPoints(50);
});

$('.book70222').click(function() {
  earnPoints(70);
});
...
function usePoints(formPoints) {
  ...
  var inputData1 = {  
      ...
      "\$class": 'org.clp.citi.UsePoints',
      points: formPoints,
      partner: "resource:org.clp.citi.Partner\#bestbuy",
      member: "resource:org.clp.citi.Customer\#"+formAccountNum
    
  };
  var inputData = '{' + '"$class" : "org.clp.citi.UsePoints" , "points" : "' + formPoints + '", ' + '"partner" : "resource:org.clp.citi.Partner\#bestbuy", '+' "member" : "resource:org.clp.citi.Customer\#' + formAccountNum + '"}';

  console.log("sud" + inputData)
